...
<template>
  ...
  >
    ...
    <ColorFieldRoot :model-value="color" channel="red" color-space="rgb" @update:color="color = $event">
      <ColorFieldInput data-slot="input-group-control" class="outline-none px-0" placeholder="h" />
    </ColorFieldRoot>

    <ColorFieldRoot :model-value="color" channel="green" color-space="rgb" @update:color="color = $event">
    ...
    <ColorFieldRoot :model-value="color" channel="blue" color-space="rgb" @update:color="color = $event">

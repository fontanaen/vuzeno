...
<template>
  ...
  >
    ...
    <ColorFieldRoot :model-value="color" channel="hue" color-space="hsb" @update:color="color = $event">
      <ColorFieldInput data-slot="input-group-control" class="outline-none px-0" placeholder="h" />
    </ColorFieldRoot>

    <ColorFieldRoot :model-value="color" channel="saturation" color-space="hsb" @update:color="color = $event">
    ...
    <ColorFieldRoot :model-value="color" channel="brightness" color-space="hsb" @update:color="color = $event">

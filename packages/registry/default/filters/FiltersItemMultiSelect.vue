...
import { computed, type HTMLAttributes, isVNode } from "vue";
...
<template>
    <Popover>
        <PopoverTrigger as-child>
            <Button :variant="variant" :class="cn('h-auto w-auto gap-1 justify-between font-normal text-sm px-3', props.class)">

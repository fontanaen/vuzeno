    ...
    >
      <Drawer.Content
        ...
        :class="cn(
          ...
          'data-[swipe-direction=left]:max-h-none data-[swipe-direction=left]:max-w-[400px]',
          ...
          'data-[swipe-direction=right]:max-h-none data-[swipe-direction=right]:max-w-[400px]',

...
<template>
  <ScrollArea.Root class="relative overflow-hidden border border-border rounded-md" orientation="vertical">
    <ScrollArea.Shadow side="top" />
    <ScrollArea.Shadow side="bottom" />

    <p class="m-0 text-sm leading-5.5 text-foreground">

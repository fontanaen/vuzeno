...
import { BookOpenIcon, HomeIcon, InboxIcon, SearchIcon, SettingsIcon } from "@lucide/vue";
    ...
    <Sidebar.Provider class="h-full">
            ...
            <Sidebar.MenuItem>
              <Sidebar.MenuButton size="lg">
                ...
                <div class="grid flex-1 text-left text-sm leading-tight">
                  <span class="truncate font-semibold">Vuzeno</span>
        ...
        <Sidebar.Content>
          <Sidebar.Group>
            ...
            <Sidebar.GroupContent>
              <Sidebar.Menu>
                <Sidebar.MenuItem>
                  <Sidebar.MenuButton is-active tooltip="Home">
                    <HomeIcon />
                    <span>Home</span>
                  </Sidebar.MenuButton>
                </Sidebar.MenuItem>
                ...
                <Sidebar.MenuItem>
                  <Sidebar.MenuButton tooltip="Docs">
                    <BookOpenIcon />
                    <span>Docs</span>
                  </Sidebar.MenuButton>
                </Sidebar.MenuItem>
          ...
          <Sidebar.Menu>
            <Sidebar.MenuItem>
              <Sidebar.MenuButton tooltip="Account">
                <span class="flex size-6 items-center justify-center rounded-full bg-sidebar-accent text-xs font-medium">JD</span>
                <span>John Doe</span>
              </Sidebar.MenuButton>
            </Sidebar.MenuItem>
          </Sidebar.Menu>
      ...
      <Sidebar.Inset>
        <header class="flex h-12 items-center gap-2 border-b px-4">
          <Sidebar.Trigger />
          <span class="text-sm font-medium">Classic sidebar</span>
        </header>

...
Vuzeno is a complete design system for Vue, built on [Ark UI](https://ark-ui.com/). You install production-ready, Tailwind-styled components into your repo with the shadcn-vue CLI, then own and customize the source. Unlike shadcn-vue (Reka UI), Vuzeno’s interactive behavior is Ark-native.

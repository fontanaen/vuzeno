...
description: Add Vuzeno as a third-party shadcn-vue registry.
...
The CLI will install the component and its registry dependencies (e.g. shadcn-vue Autocomplete, Input Group) into your project. Some components list extra npm dependencies on their docs (e.g. `libphonenumber-js` for Phone Field)—install those if prompted or as shown on the component page.

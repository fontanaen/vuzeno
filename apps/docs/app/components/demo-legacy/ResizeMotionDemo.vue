...
import { ResizeMotion } from "@vuzeno/registry/legacy/resize-motion";
...
<template>
  <Dialog.Root>
    ...
    <Dialog.Content class="overflow-hidden sm:max-w-md py-4 px-0 outline-4 outline-border">
      <ResizeMotion animation="spring" :duration="450" viewport-overflow="hidden">
        ...
        <div v-else key="done" class="space-y-5 animate-in zoom-in-95 fade-in-0 blur-in-sm duration-300">
          ...
          <div class="px-4">
            <Accordion.Root type="single" collapsible default-value="workspace" class="">
              <Accordion.Item value="workspace" class="border-border/60">
                <Accordion.ItemTrigger class="py-3 text-xs">
                  <span class="text-muted-foreground">Workspace</span>
                  <span class="ml-auto mr-3 font-medium">Acme Studio</span>
                </Accordion.ItemTrigger>
                <Accordion.ItemContent class="space-y-3 text-xs text-muted-foreground">
              ...
              <Accordion.Item value="imports" class="border-0">
                <Accordion.ItemTrigger class="py-3 text-xs">

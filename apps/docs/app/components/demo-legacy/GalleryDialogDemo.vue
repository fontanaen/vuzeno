...
import { Gallery, GalleryContent, GalleryImage, GalleryImageSource, GalleryItem, GalleryNext, GalleryPrevious, GalleryToolbar, GalleryZoomInControl, GalleryZoomOutControl } from "@vuzeno/registry/legacy/gallery";
...
<template>
  <Dialog.Root>
    ...
    <Dialog.Content class="w-full max-w-3xl overflow-hidden" :class="{ 'max-w-[90vw]': isExpanded }">
      <Gallery

...
import { componentPreviewPlugin, preprocessComponentPreview } from "./plugins/component-preview-plugin.ts";
  ...
  markdown: {
    ...
    preConfig(md) {
      ...
      md.parse = (src: string, env: object) => {
        return originalParse(preprocessComponentPreview(src), env);
      };
